  ...
  return (
    <html lang="vi">
      <body className={inter.className}>
        ...
        <meta name="description" content="Salon tóc chuyên nghiệp với đội ngũ stylist giàu kinh nghiệm. Dịch vụ cắt tóc, nhuộm, uốn, chăm sóc tóc chất lượng cao." />
        <meta name="keywords" content="salon tóc, cắt tóc, nhuộm tóc, uốn tóc, chăm sóc tóc, stylist chuyên nghiệp" />
