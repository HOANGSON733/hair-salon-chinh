...
import { getWomenHairServices, getServicesByCategoryAndType, getServiceTypesForCategory } from "@/data/service/index"
...
export default function TocNuPage() {
  ...
  const allServices = getWomenHairServices()
  const availableTypes = getServiceTypesForCategory("toc-nu")

  const filteredServices = useMemo(() => {
    return getServicesByCategoryAndType("toc-nu", selectedType)
  }, [selectedType])
  ...
  return (
    <div className="min-h-screen">
      ...
      <ServiceTypeSelect
        ...
        placeholder="Tất cả dịch vụ tóc nữ"
      />
